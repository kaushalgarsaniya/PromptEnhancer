      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 xs:p-5 sm:p-7 space-y-5 shadow-xl dark:shadow-2xl transition-colors">
        ...
        <div className="space-y-2">
          <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-1.5 xs:gap-2">
            ...
            <span className="inline-flex items-center gap-1 text-[10px] sm:text-[11px] font-semibold text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/80 px-2 py-0.5 rounded-md border border-emerald-200 dark:border-emerald-800/80">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 xs:p-5 sm:p-7 space-y-5 shadow-lg dark:shadow-2xl transition-colors">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-zinc-200 dark:border-zinc-800">
            <div className="flex flex-wrap items-center gap-2">
              ...
              {result.detectedLanguage && (
                <span className="px-2 py-0.5 rounded-md text-[10px] sm:text-[11px] font-semibold bg-blue-50 dark:bg-blue-950/80 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800/80 inline-flex items-center gap-1">
          ...
          <div className="space-y-2">
            ...
            <div className="rounded-xl border border-zinc-800 dark:border-zinc-800 bg-zinc-900 dark:bg-zinc-950 overflow-hidden shadow-sm">
              <div className="p-3.5 sm:p-5 text-xs sm:text-sm text-white dark:text-zinc-100 leading-relaxed font-mono whitespace-pre-wrap min-h-[150px] sm:min-h-[170px] max-h-80 sm:max-h-96 overflow-y-auto break-words">
