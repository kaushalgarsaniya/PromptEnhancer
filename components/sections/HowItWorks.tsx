...
export const HowItWorks: React.FC = () => {
  ...
  return (
    <section id="how-it-works" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {steps.map((s) => {
          ...
          return (
            <div
              key={s.num}
              className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800 space-y-3 hover:border-zinc-300 dark:hover:border-zinc-700 shadow-sm dark:shadow-none transition-colors"
            >
              <div className="flex items-center justify-between">
                <span className="text-2xl font-mono font-bold text-zinc-400 dark:text-zinc-500">{s.num}</span>
